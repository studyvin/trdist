...
## #'
## #' @description Performs method of moments estimation
## #'
## #'
...
## #'
## #'
## #' @details The function calculates the weighted mean and weighted variance and performs a method of moments approach to obtain start values for the likelihood estimation.
## #'
## #'
...
## getStartValue <- function(x,distr, w=rep(1,length(x)),...){
##     ## for debugging
##     ## x <- rbeta(100,2,17)
##     ## hist(x)
##     ## w <- rep(1,length(x))
